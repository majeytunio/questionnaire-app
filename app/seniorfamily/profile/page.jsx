...
export default function AdminSettingsPage() {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      if (!profileData || profileData.user_type !== 'user') {
        router.push('/');
        return;
      }
  ...
  return (
    <>
      ...
      <main className="container mx-auto mt-10 space-y-10">
        <h1 className="text-3xl font-bold">Senior Family Settings</h1>

        {/* Admin Account */}
        <section className="dark:bg-[var(--block-secondary)] p-6 rounded-xl shadow">
          <h2 className="text-xl font-semibold mb-4">Senior Family Account</h2>
