...
// // // // import translations from './TestQuestions.jsx';
...
// // // import React, { useState, useEffect, useRef } from 'react';
// // // import translations from './Questions.jsx';
// // // import { generateReport } from './Models/ReportGenerator';
...
// // //         // Show report button after a short delay
// // //         setTimeout(() => {
...
// // //   // Handler for sending a message
// // //   const handleSendMessage = async () => {
// // //     if (input.trim() === '' || assessmentCompleted) return;
...
// // //     // Store the user's response
// // //     const handleQuestionnaire = getQuestionnaire();
// // //     const currentSection = handleQuestionnaire[currentSectionIndex].title;
// // //     const currentQuestion = handleQuestionnaire[currentSectionIndex].questions[currentQuestionIndex];
...
// // //     Provide a brief, empathetic, and encouraging response (1-2 sentences) and then prepare to ask the next question. 
// // //     Do not repeat the user's answer verbatim. Keep it natural and conversational. I strongly force you to reply in ${language}.
// // //     If all questions are completed, respond with the markdown for final assessment report and add [final] at the end of the final assessment report.`;
...
// // //     const questionnaire = getQuestionnaire();
// // //     const isFinalQuestion = currentSectionIndex === questionnaire.length - 1 && 
// // //                            currentQuestionIndex === questionnaire[questionnaire.length - 1].questions.length - 1;
    
// // //     // Only move to next question if it's not the final one
// // //     if (!isFinalQuestion) {
// // //       setTimeout(() => {
// // //         nextQuestion();
// // //       }, 1500);
// // //     } else {
// // //       // This is the final question, mark assessment as completed
// // //       setAssessmentCompleted(true);
...
// // //     setIsLoading(true);
// // //     try {
// // //       await generateReport(userResponses, language);
// // //     } catch (error) {
...
// // //   const handleKeyDown = (event) => {
// // //     if (event.key === 'Enter' && !isLoading && !assessmentCompleted) {
// // //       handleSendMessage();
// // //     }
// // //   };
...
// // //   // Check if all questions are completed
// // //   const questionnaire = getQuestionnaire();
// // //   const allQuestionsCompleted = assessmentCompleted;
...
// // //           className="bg-indigo-500 h-2 transition-all duration-500" 
// // //           style={{ 
// // //             width: assessmentCompleted ? '100%' : `${((currentSectionIndex * 100 + (currentQuestionIndex / questionnaire[currentSectionIndex].questions.length) * 100) / questionnaire.length)}%` 
// // //           }}
// // //         ></div>
// // //       </div>
...
// // //           )}
// // //           {showReportButton && (
// // //             <div className="p-4 rounded-3xl max-w-2/3 shadow-lg my-2 bg-green-700 text-white self-start rounded-bl-none">
// // //               <div className="flex flex-col items-start">
// // //                 <span className="text-base leading-relaxed mb-2">{translations[language].reportReady}</span>
// // //                 <button
// // //                   onClick={handleDownloadReport}
// // //                   disabled={isLoading}
// // //                   className="px-4 py-2 bg-white text-green-700 rounded-md font-medium hover:bg-gray-100 transition-colors duration-200 disabled:opacity-50"
// // //                 >
// // //                   {isLoading ? translations[language].generatingReport : translations[language].downloadReport}
// // //                 </button>
// // //               </div>
// // //             </div>
// // //           )}
...
// // import translations from './Questions.jsx';
// // import { generateReport } from './Models/ReportGenerator';
// // import { supabase } from '../lib/supabase.js'; // Assuming path to your supabase client
...
// // // Main App component
// // export default function App() {
// //   // State variables for the chat and assessment flow
// //   const [messages, setMessages] = useState([]);
// //   const [input, setInput] = useState('');
// //   const [isLoading, setIsLoading] = useState(false);
// //   const [currentSectionIndex, setCurrentSectionIndex] = useState(0);
...
// //   // // 1. Get User Session and Initial State
// //   // useEffect(() => {
...
// //   //       // 2. Try to load saved assessment state
...
// //   //       if (savedAssessment) {
// //   //         // Found saved state, load it
// //   //         setMessages(savedAssessment.messages || []);
// //   //         setCurrentSectionIndex(savedAssessment.section_index || 0);
// //   //         setCurrentQuestionIndex(savedAssessment.question_index || 0);
// //   //         setUserResponses(savedAssessment.responses || {});
// //   //         setLanguage(savedAssessment.language || 'English');
// //   //         setAssessmentCompleted(savedAssessment.completed || false);
// //   //         setShowReportButton(savedAssessment.show_report_button || false);
// //   //         // Only show 'thinking' if still loading, otherwise show the next question
// //   //         if (!savedAssessment.completed) {
// //   //           const questionnaire = translations[savedAssessment.language || 'English']?.questionnaire || translations.English.questionnaire;
// //   //           const sectionIndex = savedAssessment.section_index || 0;
// //   //           const questionIndex = savedAssessment.question_index || 0;
// //   //           const currentQuestion = questionnaire[sectionIndex].questions[questionIndex];

// //   //           // If last message wasn't the current question, post it
// //   //           if (savedAssessment.messages?.length === 0 || 
// //   //               savedAssessment.messages[savedAssessment.messages.length - 1].text !== currentQuestion) {
                
// //   //               let initialMessage = currentQuestion;
// //   //               if (sectionIndex === 0 && questionIndex === 0) {
// //   //                   initialMessage = `${translations[savedAssessment.language || 'English'].welcome}${questionnaire[sectionIndex].title}. ${currentQuestion}`;
// //   //               } else if (questionIndex === 0) {
// //   //                   initialMessage = `${translations[savedAssessment.language || 'English'].nextSection}${questionnaire[sectionIndex].title}. ${currentQuestion}`;
// //   //               }
...
// //   //       } else if (!error || error.code === 'PGRST116') { // No data found (PGRST116 is no rows found)
// //   //         // No saved state, start a new assessment
// //   //         const questionnaire = getQuestionnaire();
// //   //         const firstQuestion = questionnaire[0].questions[0];
// //   //         setMessages([{
// //   //           sender: 'bot',
// //   //           text: `${translations[language].welcome}${questionnaire[0].title}. ${firstQuestion}`
// //   //         }]);
// //   //       }
// //   //     } else {
// //   //       // Handle case where user is not logged in (e.g., redirect to login)
// //   //       // For now, we'll start a new assessment without persistence
// //   //       const questionnaire = getQuestionnaire();
// //   //       const firstQuestion = questionnaire[0].questions[0];
// //   //       setMessages([{
// //   //         sender: 'bot',
...
// //     const fetchSessionAndData = async () => {
// //         const { data: { user } } = await supabase.auth.getUser();
// //         const questionnaire = getQuestionnaire(); // Use current language questionnaire
...
// //             if (savedAssessment && savedAssessment.messages && savedAssessment.messages.length > 0) {
// //                 // 1. RESTORE STATE
// //                 setMessages(savedAssessment.messages);
// //                 setCurrentSectionIndex(savedAssessment.section_index || 0);
// //                 setCurrentQuestionIndex(savedAssessment.question_index || 0);
...
// //                 setShowReportButton(savedAssessment.show_report_button || false);
// //             } else {
// //                 // 2. START NEW CHAT (No saved history found)
// //                 const firstQuestion = questionnaire[0].questions[0];
// //                 setMessages([{
// //                     sender: 'bot',
// //                     text: `${translations[language].welcome}${questionnaire[0].title}. ${firstQuestion}`
...
// //             }
// //         } else {
// //             // 3. START NEW CHAT (Not logged in)
// //             const firstQuestion = questionnaire[0].questions[0];
// //             setMessages([{
// //                 sender: 'bot',
// //                 text: `${translations[language].welcome}${questionnaire[0].title}. ${firstQuestion}`
...
// //         // 🛑 CRITICAL: Mark loading complete only AFTER all state has been set
...
// //       .from(ASSESSMENTS_TABLE)
// //       .upsert(state, { 
// //         onConflict: 'user_id' // Update the existing row for this user
// //       });
...
// //   // Effect to save state whenever core variables change
// //   useEffect(() => {
// //     // Only save after initial load/restore if userId is set
// //     if (userId) {
// //       saveAssessmentState(
// //         messages, 
// //         currentSectionIndex, 
...
// //     showReportButton,
// //     userId,
// //     saveAssessmentState // Dependency on the memoized function
// //   ]);
...
// //   useEffect(() => {
// //     if (!isInitialLoadComplete) return; // Wait for initial state to load/restore

// //     // Reset current question indexes and post the first question in the new language
// //     const questionnaire = getQuestionnaire();
// //     const firstQuestion = questionnaire[0].questions[0];
    
// //     // Only reset if the chat is not active
// //     if (messages.length === 0 || assessmentCompleted) {
// //          setMessages([{ 
// //             sender: 'bot', 
// //             text: `${translations[language].welcome}${questionnaire[0].title}. ${firstQuestion}` 
// //         }]);
...
// //   }, [language, isInitialLoadComplete]);
...
// //   // --- Core Application Logic (Modified for state update) ---

// //   // Function to call the OpenAI API for text generation (remains the same)
// //   const callOpenAIAPI = async (prompt) => {
// //     // ... (Your original callOpenAIAPI function remains here) ...
// //     const payload = {
// //       model: "gpt-3.5-turbo",
// //       messages: [{ role: "user", content: prompt }],
// //       max_tokens: 150,
...
// //   //   let newAssessmentCompleted = false;
// //   //   let newShowReportButton = false;
...
// //   //     newMessages = [...newMessages, { sender: 'bot', text: nextQuestion }];
// //   //   } else {
// //   //     // Move to the next section
// //   //     if (currentSectionIndex < questionnaire.length - 1) {
// //   //       nextSectionIndex = currentSectionIndex + 1;
// //   //       nextQuestionIndex = 0;
// //   //       const nextSection = questionnaire[nextSectionIndex];
// //   //       const nextQuestion = nextSection.questions[0];
...
// //   //   setAssessmentCompleted(newAssessmentCompleted);
// //   //   // Note: The saveAssessmentState effect will handle persistence after state update
// //   // };



// //   // Function to determine the next question/section text
// //   const getNextQuestionText = (nextSectionIndex, nextQuestionIndex, questionnaire, language) => {
// //       // All questions completed
// //       if (nextSectionIndex >= questionnaire.length) {
// //           return translations[language].completion;
// //       }

// //       const nextSection = questionnaire[nextSectionIndex];
// //       const nextQuestion = nextSection.questions[nextQuestionIndex];
      
// //       // Starting a new section
// //       if (nextQuestionIndex === 0 && nextSectionIndex > currentSectionIndex) {
// //           return `${translations[language].nextSection}${nextSection.title}. ${nextQuestion}`;
// //       }
...
// //   // Function to move to the next question and return the text for the AI prompt
// //   const nextQuestion = () => {
// //       const questionnaire = getQuestionnaire();
// //       const currentSection = questionnaire[currentSectionIndex];
...
// //       // Update state synchronously for the saveAssessmentState useEffect to catch the new position
// //       setCurrentSectionIndex(nextSectionIndex);
// //       setCurrentQuestionIndex(nextQuestionIndex);
// //       setAssessmentCompleted(newAssessmentCompleted);
      
// //       // Return the text for the AI prompt
// //       if (newAssessmentCompleted) {
// //           return translations[language].completion;
// //       }

// //       return getNextQuestionText(nextSectionIndex, nextQuestionIndex, questionnaire, language);
// //   };
...
// //     // Store the user's response
// //     const handleQuestionnaire = getQuestionnaire();
// //     const currentSectionTitle = handleQuestionnaire[currentSectionIndex].title;
// //     const currentQuestionText = handleQuestionnaire[currentSectionIndex].questions[currentQuestionIndex];
    
// //     const newResponses = {
// //       ...userResponses,
// //       [currentSectionTitle]: {
// //         ...(userResponses[currentSectionTitle] || {}),
// //         [currentQuestionText]: input
// //       }
// //     };
...
// //     // Create a prompt for OpenAI
// //     const prompt = `You are conducting a comprehensive assessment. The user just answered the question: 
// //     "${currentQuestionText}" with: "${input}". 
// //     Provide a brief, empathetic, and encouraging response (1-2 sentences) and then prepare to ask the next question. 
// //     Do not repeat the user's answer verbatim. Keep it natural and conversational. I strongly force you to reply in ${language}.
// //     If all questions are completed, respond with the markdown for final assessment report and add [final] at the end of the final assessment report.`;
...
// //     setIsLoading(false);
// //     const finalMessages = [...newMessages, { sender: 'bot', text: botResponseText }];
...
// //   // Function to handle PDF download (same as original)
// //   const handleDownloadReport = async () => {
// //     setIsLoading(true);
// //     try {
// //       // Pass both responses and the full questionnaire structure for analysis
// //       await generateReport(userResponses, getQuestionnaire(), language); 
// //     } catch (error) {
// //       console.error("Error generating report:", error);
// //     }
// //     setIsLoading(false);
...
// //   // ... (Rest of the component: handleKeyDown, ChatBubble, and Render logic) ...
...
// //       <div className="w-full flex justify-between items-center p-4 bg-gray-900 shadow-md">
// //         <div className="flex items-center">
// //           <svg xmlns="http://www.w3.0g/2000/svg" className="h-6 w-6 text-blue-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
// //             <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
// //           </svg>
// //           <h1 className="text-xl font-bold tracking-tight">{translations[language].title}</h1>
// //         </div>
...
// //         <div className="text-xl text-indigo-400">Loading Assessment...</div>
// //     )}
// //     {isInitialLoadComplete && (
// //         <div className="w-full max-w-3xl flex flex-col space-y-4">
// //             {messages.map((msg, index) => (
...
// //       {/* Input area */}
// //       {isInitialLoadComplete && !assessmentCompleted && (
// //         <div className="w-full p-4 bg-gray-900 shadow-lg flex justify-center">
// //           <div className="flex w-full max-w-3xl rounded-full border border-gray-700 bg-gray-800 focus-within:ring-2 focus-within:ring-indigo-500 transition-all duration-300">
// //             <input
// //               type="text"
...
//   const [finalAnalysisText, setFinalAnalysisText] = useState(null); 
...
//           // Try to load saved assessment state
//           const { data: savedAssessment, error } = await supabase
//             .from(ASSESSMENTS_TABLE)
//             .select('*')
//             .eq('user_id', user.id)
...
//             // Found saved state, load it completely
//             console.log('Loading saved assessment:', savedAssessment);
...
//             console.log('No saved assessment found, starting fresh');
//             startNewAssessment();
//           }
//         } else {
//           // User not logged in, start fresh without persistence
//           console.log('User not logged in, starting fresh');
//           startNewAssessment();
//         }
//       } catch (error) {
//         console.error('Error fetching session and data:', error);
//         startNewAssessment();
//       } finally {
//         setIsInitialLoadComplete(true);
//       }
...
//       }
//     } catch (error) {
//       console.error('Exception in saveAssessmentState:', error);
//     }
//   }, [userId]);
...
//   // Effect to handle language changes without resetting progress
//   useEffect(() => {
//     if (!isInitialLoadComplete) return;

//     // Only reset if we're at the very beginning with no meaningful progress
//     const hasProgress = messages.length > 1 || currentSectionIndex > 0 || currentQuestionIndex > 0 || Object.keys(userResponses).length > 0;
    
//     if (!hasProgress && !assessmentCompleted) {
//       console.log('Resetting for language change with no progress');
//       const questionnaire = getQuestionnaire();
//       const firstQuestion = questionnaire[0].questions[0];
//       setMessages([{ 
//         sender: 'bot', 
...
//       setCurrentQuestionIndex(0);
//     }
//     // If there's existing progress, we keep it but future questions will be in the new language
//   }, [language, isInitialLoadComplete]);
...
//   // Function to get the next question text
//   const getNextQuestionText = (nextSectionIndex, nextQuestionIndex) => {
//     const questionnaire = getQuestionnaire();
...
//     // Get the next question text before updating state
//     const nextQuestionText = newAssessmentCompleted 
//       ? translations[language].completion
//       : getNextQuestionText(nextSectionIndex, nextQuestionIndex);
...
//     // Add the next question to messages if not completed
//     if (!newAssessmentCompleted) {
//       setMessages(prev => [...prev, { sender: 'bot', text: nextQuestionText }]);
//     } else {
...
//         if (userId) {
//           saveAssessmentState(
//             [...messages, { sender: 'bot', text: nextQuestionText }],
//             nextSectionIndex,
//             nextQuestionIndex,
//             userResponses,
//             language,
...
//   // Handler for sending a message
//   const handleSendMessage = async () => {
//     if (input.trim() === '' || assessmentCompleted || !isInitialLoadComplete) return;
...
//     // Store the user's response
//     const questionnaire = getQuestionnaire();
//     const currentSectionTitle = questionnaire[currentSectionIndex].title;
//     const currentQuestionText = questionnaire[currentSectionIndex].questions[currentQuestionIndex];
...
//     // New logic to insert around Line 41

//     const isFinalQuestion = currentSectionIndex === questionnaire.length - 1 && 
//                             currentQuestionIndex === questionnaire[questionnaire.length - 1].questions.length - 1;

//     // If it's the final question, save the report text and display it immediately. 
//     if (isFinalQuestion) {
//       const reportText = botResponseText.includes('[final]') 
//         ? botResponseText.replace('[final]', '').trim() 
//         : botResponseText;
//         
//       // 1. Store the clean report text in state
//       setFinalAnalysisText(reportText);
//         
//       // 2. Display the full AI message in the chat (report text + [final])
//       const finalMessages = [...newMessages, { sender: 'bot', text: botResponseText }];
//       setMessages(finalMessages);
//       
//       // 3. The assessment is complete. Wait 1.5s then show the button.
//       setTimeout(() => {
//         setAssessmentCompleted(true);
//         setShowReportButton(true);
//       }, 1500);
...
//     } else {
//       // If not the final question, display the AI response and move to the next question.
//       const finalMessages = [...newMessages, { sender: 'bot', text: botResponseText }];
//       setMessages(finalMessages);

//       // Call nextQuestion after a delay
//       setTimeout(() => {
//         nextQuestion();
//       }, 1500);
//     }
//   }; // The function ends here, removing the final 'if' block.
...
//       await generateReport(userResponses, getQuestionnaire(), language, finalAnalysisText);
      
//       // Update the completed status in database after report download
//       if (userId) {
...
//   const handleKeyDown = (event) => {
//     if (event.key === 'Enter' && !isLoading && !assessmentCompleted && isInitialLoadComplete) {
//       handleSendMessage();
//     }
//   };
...
//               onClick={handleSendMessage}
//               className="p-4 text-indigo-400 hover:text-indigo-300 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
//               disabled={isLoading || input.trim() === '' || !isInitialLoadComplete}
//             >
//               <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
//                 <path d="M5 12h14M12 5l7 7-7 7" />
//               </svg>
